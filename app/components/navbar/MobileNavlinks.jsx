                ...
                <div className='grid content-between h-full grid-rows-[1fr_auto]'>
                    <nav className='pb-[3rem] '>
                        <ul className='list-menu p-0 m-0 list-none'>
                            <li>
                                <a href="/" className={`menu-item font-neuton ${pathname === '/' && 'active'}`} >Home</a>
                            </li>
                            <li>
                                <a href="/products" className={`menu-item font-neuton ${pathname === '/products' && 'active'}`} >Product</a>
                            </li>
                            <li>
                                <a href="/faq" className={`menu-item font-neuton ${pathname === '/faq' && 'active'}`} >Faq</a>
                            </li>
                        </ul>
                    </nav>
                    <div className='py-[1.2rem] px-[2rem] gap-1 bg-[#27272a] relative flex justify-center flex-col items-center'>
                        <a href="/" className={`group flex items-center py-[1rem] cursor-pointer underline-offset-[.3rem] bg-transparent leading-[1.3]  text-white text-[28px] font-semibold uppercase font-neuton `}>
                        ...
                        <ul className='flex justify-start ml-[-1.25rem] list-none'>
                            <li>
                                <a href="" className={`group p-[1.1rem] text-white items-center flex cursor-pointer underline underline-offset-[.3rem] bg-transparent text-[1.4rem] font-neuton `}>
